...
export class Database {
  ...
  private static async initializeSqlServerSchema(): Promise<void> {
    ...
    const queries = [
      `IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='users' AND xtype='U')
       CREATE TABLE users (
         ...
         telegram_verified BIT DEFAULT 0,
      ...
      `IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='reminders' AND xtype='U')
       CREATE TABLE reminders (
         ...
         telegram_error NVARCHAR(MAX) NULL,
         telegram_attempts INT DEFAULT 0,
         telegram_last_attempt_at DATETIME NULL,
    ...
    const alters = [
      ...
      `IF COL_LENGTH('users','country_code') IS NULL ALTER TABLE users ADD country_code NVARCHAR(10) NULL`,
      `IF COL_LENGTH('users','telegram_chat_id') IS NULL ALTER TABLE users ADD telegram_chat_id NVARCHAR(50) NULL`,
      `IF COL_LENGTH('users','telegram_verified') IS NULL ALTER TABLE users ADD telegram_verified BIT DEFAULT 0`,
      ...
      `IF COL_LENGTH('reminders','created_by') IS NULL ALTER TABLE reminders ADD created_by NVARCHAR(20) NULL`,
      `IF COL_LENGTH('reminders','telegram_sent') IS NULL ALTER TABLE reminders ADD telegram_sent BIT DEFAULT 0`,
      `IF COL_LENGTH('reminders','telegram_sent_at') IS NULL ALTER TABLE reminders ADD telegram_sent_at DATETIME NULL`,
      `IF COL_LENGTH('reminders','telegram_error') IS NULL ALTER TABLE reminders ADD telegram_error NVARCHAR(MAX) NULL`,
      `IF COL_LENGTH('reminders','telegram_attempts') IS NULL ALTER TABLE reminders ADD telegram_attempts INT DEFAULT 0`,
      `IF COL_LENGTH('reminders','telegram_last_attempt_at') IS NULL ALTER TABLE reminders ADD telegram_last_attempt_at DATETIME NULL`,
  ...
  private static async initializeSqliteSchema(): Promise<void> {
    ...
    const reminderAlters = [
      ...
      `ALTER TABLE reminders ADD COLUMN telegram_sent INTEGER DEFAULT 0`,
      `ALTER TABLE reminders ADD COLUMN telegram_sent_at TEXT`,
      `ALTER TABLE reminders ADD COLUMN telegram_error TEXT`,
      `ALTER TABLE reminders ADD COLUMN telegram_attempts INTEGER DEFAULT 0`,
      `ALTER TABLE reminders ADD COLUMN telegram_last_attempt_at TEXT`,
    ...
    const userAlters = [
      ...
      `ALTER TABLE users ADD COLUMN telegram_verified INTEGER DEFAULT 0`,
